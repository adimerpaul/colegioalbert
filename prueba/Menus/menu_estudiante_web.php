...
<div class="col-md-6">
  <table class="table table-bordered table-hover" width="500" align="center">
    <tr>
      <th class="success" colspan="3"><div align="center"><font face="consolas" size="6" color="rgb(2,0,36)">Menu Estudiante</font></div></th>
    </tr>
    <tr>
      <td align="center">
        <a href="Estudiante/mostrar_estudianteWeb.php?id=<?php echo $user ?>" class="btn btn-warning" target="_blank">
        <img src="../Imagenes/nuevo_estu.jpg" width="100" height="100"><br><b>Editar Estudiante</b>
        </a>
      </td>
      <!----
      <?php
      ...
      ---->
      <td align="center">
        <a href="Estudiante/mostrar_estudianteWeb.php?id=<?php echo $user ?>"  target="_blank">
        <img src="../Imagenes/estudiante.jpg" width="100" height="100"><br><b>Pre inscripción</b>
        </a>
      </td>
      <td align="center">
        <a href="Estudiante/mostrar_estudiante3.php?id=<?php echo $user ?>"  target="_blank">
        <img src="../Imagenes/estudiante.jpg" width="100" height="100"><br><b>Información académica</b>
        </a>
      </td>
    </tr>
    ...
    <tr>
      <td></td>
      <td align="center" width="142"><a href="../aulaalberteinstein/aulaalberteinstein/prueba/index.html" class="btn btn-danger">
