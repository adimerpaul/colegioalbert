<?php
	...
	include "../../conexion.php";
	  mysqli_query($conectador,"INSERT INTO `recibo`(`id_recibo`,`id_usuario`,`tiempo_cobro`,`rude_estu`,`gestion`,`observaciones`) VALUES (null,$usuario,NOW(),'$rude',$y,'$descri');");
...
$pdf->SetX(65);
$pdf->Cell(80,10,"BOLETIN DE PENSIONES",0,1,"C");//ancho, alto, contenido,borde,alineacion de la siguiente celda,alineacion de texto
...
$pdf->SetX(35);//para darle espacio a la imagen
$pdf->Cell(20,5,utf8_decode("Cиоdigo est.: "),0,0);
...
$pdf->Cell(75,10,"Mensualidad","LRB",0,"C");
