  ...
  <form name="form1" method="post" action="" class="form-horizontal">
      <div class="row">
        ...
        <div class="form-group">
            ...
            <script type="text/javascript" src="../../Librerias/calendario/tcal.js"></script>
                <div class="col-sm-5 col-md-5">
                  <label for="date1" class="control-label">Fecha inicioooo</label>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4">
            ...
            ?></center></b></h4>
            <center>
              <a class="btn btn-warning" href="pro_eli_recibo.php?re=<?php echo $dat?>&user=<?php echo $user?>">
    ...
    <table class="table table-hover" id="table2excel">
      <tr>
        ...
        <td bgcolor="YELLOW"><b><font color="BLACK">Mensualidad cobrada</b></td>
    ...
    if($cam=="Recibo"){
    $res=mysqli_query($conectador,"select * from pago_estudiantes where id_recibo='$dat';");
    }
    ...
    $total=0;
      ...
      ?>
       <tr>
        <td class="success"><a class="btn btn-danger" href="pro_eli_cobro.php?idf=<?php echo $i[0]?>&user=<?php echo $user?>">
