        ...
        <div class="panel-body">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-5">
                        <input class="form-control" type="text" name="nom_estu" id="nom_estu" onKeyUp="this.value = this.value.toUpperCase();" value="<?php echo $i['nombre'];?>"required/>
                     </div>
                     </div>
                     ...
                     <div class="form-group" >
                      ...
                      <div class="col-md-4">
                        <input class="form-control" type="text" name="ap_pat" id="ap_pat" onKeyUp="this.value = this.value.toUpperCase();" value="<?php echo $i[2];?>"required/>
                      </div>
                     </div>
             ...
             <div class="panel-body">
               <div class="row">
                 <div class="col-md-4" style="background-color: #e4e9f0;">
                  ...
                  <input class="form-control" type="number" name="ci_pat" id="ci_pat2" style="width: 200;" value="<?php echo $i[11];?>"required/>
                  ...
                  <label for="ocup_padre" class="control-label"> Ocupacion Padre:</label>
                 ...
                 <div class="col-md-4" style="background-color: #f5e1d4;">
                  ...
                  <input class="form-control" type="number" name="ci_mat" id="ci_mat2" style="width: 200;" value="<?php echo $i[13];?>"required/>
                 ...
                 <div class="form-group col-md-4" style="background-color:#d8d8d8;">
                  ...
                  <input class="form-control" type="number" name="ci_tuto" id="ci_tuto" style="width: 200;" value="<?php echo $i[17];?>"/>
                ...
                <div class="form-group col-md-12">      
                  <B><P class="control-label col-md-6">DATOS PARA FACTURACIÓN:</P></B></br><br>
                  ...
                  <label for="ci_factur" class="control-label col-md-6">C.I. para Factura:</label> 
