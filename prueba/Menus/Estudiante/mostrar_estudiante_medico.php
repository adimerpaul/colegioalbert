...
//PAGINACION
 ...
 <!-- <td><a href="modificar_estudiante_med.php" class="btn btn-warning"  target="CUERPO"><span class="glyphicon glyphicon-edit"></span>Modificar</a>
  ...
  <td><a href="../Pagos/form_consulta.php?id=<?php echo $f[0];?>&d2=<?php echo $usuario;?>" target="_blank" class="open-Modal btn btn-success"><span class="glyphicon glyphicon-usd"></span>Consulta médica</a>
  ...
  <a href="#" data-toggle='modal' data-target='#ver_estudiante' class='open-Modal btn btn-info' onclick="obtener_datos('<?php echo $f[8];?>');"><span class='glyphicon glyphicon-eye-open'></span> Historia Clínica</a>
