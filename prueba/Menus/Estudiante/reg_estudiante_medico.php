...
<form id="form1" name="form1" method="post" action="pro_reg_estudiante_medico.php" class="form-horizontal">
      ...
      <div class="form-group" >
                        <label for="curso2" class="control-label col-md-2">CURSO: </label>
                        <div class="col-md-2">
                          <input class="form-control" type="text" name="curso" id="curso2" onKeyUp="this.value = this.value.toUpperCase();" value="<?php echo $i['curso'];?>"readonly/>
                        </div>
                      </div>
      ...
      <div cass="col-md-1"></div>
      <div class="col-md-3"><input type="text" name="alergia" id="ap_pat"  class="form-control" onKeyUp="this.value = this.value.toUpperCase();"value='0' placeholder="" /></div>
      </div>
