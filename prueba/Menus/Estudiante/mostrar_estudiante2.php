...
//PAGINACION
  ...
  $res=mysqli_query($conectador,"select * from estudiante where nombre like '%$dato%' and apellido_pat like '%$dato1%' and apellido_mat like '%$dato2%' and estado=true LIMIT $pag_actual,$porPaginas;");
  ...
  if($lista=="activos"){
  $res=mysqli_query($conectador,"select * from estudiante where nombre like '%$dato%' and apellido_pat like '%$dato1%' and apellido_mat like '%$dato2%' and estado=TRUE LIMIT $pag_actual,$porPaginas;"); //LIMIT: LIMITA UN RANGO DE LA DB.. SINTAXIS-> LIMIT(INICIO,CANTIDAD)
  }
  if($lista=="retirados"){
  $res=mysqli_query($conectador,"select * from estudiante where nombre like '%$dato%' and apellido_pat like '%$dato1%' and apellido_mat like '%$dato2%' and estado=FALSE LIMIT $pag_actual,$porPaginas;"); //LIMIT: LIMITA UN RANGO DE LA DB.. SINTAXIS-> LIMIT(INICIO,CANTIDAD)
  }
  ...
  <tr>
  <td></td>
  <td><a href="../Pagos/form_pagos.php?id=<?php echo $f[8];?>&d2=<?php echo $usuario;?>" target="_blank" class="open-Modal btn btn-success"><span class="glyphicon glyphicon-usd"></span>Cobrar</a>
  </td>
