...
<div class="container">
  ...
  <table class="table table-hover table-condensed" id="table2excel" style="border-color:white;" border='0'>
    <tr>
    <td align="center" bgcolor="#33FF99"><a href="reporte_estudiante3.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-down"></span>Descargar</a></td>
...
//PAGINACION
  ...
  <td><a href="../Pagos/form_pagos.php?id=<?php echo $f[8];?>&d2=<?php echo $usuario;?>" target="_blank" class="open-Modal btn btn-success"><span class="glyphicon glyphicon-usd"></span>Cobrar mensualidad</a>

  </td>
  <td><a href="../Pagos/form_pagos2.php?id=<?php echo $f[8];?>&d2=<?php echo $usuario;?>" target="_blank" class="open-Modal btn btn-success"><span class="glyphicon glyphicon-usd"></span>Otros cobros</a>
