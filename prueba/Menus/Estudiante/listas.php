    ...
    <div class="panel-body">
        ...
        <tr>
          ...
          ?>
            ...
            <td>
            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#ver_estudiante" onclick="obtener_datos('<?php echo $f[8];?>')"><span class="glyphicon glyphicon-search"></span>Ver</a>
            <?php
            ...
            <td>
              <a href="modificar_estudiante.php?id=<?php echo $f[8]?>" class="btn btn-warning">
