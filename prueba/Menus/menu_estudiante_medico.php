...
<div class="col-md-6">
  <table class="table table-bordered table-hover" width="500" align="center">
    ...
    <tr>
      ...
      <td align="center">
        <a href="Estudiante/mostrar_estudiante_medico.php?id=<?php echo $id_cajero?>" class="btn btn-info" target="CUERPO">
      ...
      <td align="center">
        ...
        <img src="../imagenes/info_consulta.jpg" width="100" height="100"><br>Información de Consultas
        </a>
      </td>
