      ...
      <div class="panel panel-primary" style="background-color: white">
        ...
        <div class="panel-body">
           ...
           <center><p><img src="imagenes/image.jpg" width="220" height="230" style="border-radius:50px"></p></center>
            ...
            <form id="form1" name="form1" method="post" action="pro_acceso_medico.php" class="form-horizontal">
...
;" placeholder="Ingresar Contraseña" />
                  ...
                  <div class="form-group">
                   ...
                   <center><p><img src="imagenes/corazon.png" width="140" height="100" style="border-radius:50px"></p></center>
                  </div>
