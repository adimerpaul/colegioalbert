...
if($fila[29]== '0'){
	...
	$urlDir='Menus/Estudiante/modificar_estudiante2.php?id='.$fila[8];
	    if (!headers_sent()){
		     header("Location:Menus/Estudiante/modificar_estudiante2.php?id=$fila[8]");
        ...
        echo "<CENTER><p style='font-size: x-large;'>Ya realizo la PRE - INSCRIPCION, Muchas gracias. </p></CENTER>";
		echo "<a href='loginEstudiante.php' style='font-size: x-large;'>RETORNAR</a>";
     }
