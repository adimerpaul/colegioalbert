    ...
    <td>
      <div class="panel panel-primary" style="background-color: white">
        ...
        <div class="panel-body">
           ...
           <center><p><img src="imagenes/image.jpg" width="220" height="230" style="border-radius:50px"></p></center>
          
            <form id="form1" name="form1" method="post" action="pro_acceso_academico.php" class="form-horizontal">
                  <font face="calibri" style="color: #0e2f44;">
                  <div class="form-group">
                   <label class="control-label col-md-3 col-sm-3" for="user">Usuario:</label>
                    <div class="col-md-8 col-sm-8 ">
                   
                      <input class="form-control" type="text" name="user" id="user" style="background-color: #efefc8;" placeholder="Ingresar Usurario"/>
...
;" placeholder="Ingresar Contraseña" />
                  ...
                  <div class="form-group">
                   ...
                   <center><p><img src="imagenes/logoacademico.png" width="140" height="130" style="border-radius:50px"></p></center>
                  </div>
