...
/*if($VAR==$pas){
	...
	mysqli_close($conectador);*/
		...
		include "conexion.php";
			...
			$query="select * from usuario where usuario='$usu' and password='$pas';";
...
if($fila){ 
	$urlDir='Menus/menu_academico.php?id='.$fila[0];
	    if (!headers_sent()){
		     header("Location:Menus/menu_academico.php?id=$fila[0]");
		}else {
...
if($fila[3]=="Docente")
	{
		...
		echo "<a href='salud.php'>RETORNAR</a>";
