...
<meta charset="UTF-8">
  ...
  <title>Colegio_Albert_Einstein 2022</title>
      ...
      <div class="panel panel-primary" style="background-color: white">
        ...
        <div class="panel-body">
           ...
           <center><p><img src="imagenes/image.jpg" width="246" height="277" style="border-radius:50px"></p></center>
            ...
            <form id="form1" name="form1" method="post" action="pro_acceso_estudiante_medico.php" class="form-horizontal">
                  <font face="calibri" style="color: #0e2f44;">
                  <div class="form-group">
                   <label class="control-label col-md-3 col-sm-3" for="user">Usuario:</label>
                    <div class="col-md-8 col-sm-8 ">
                   
                      <input class="form-control" type="text" name="user" id="user" style="background-color: #efefc8;" placeholder="Apellido paterno o materno" required/>
...
;" placeholder="Proporcionado en inscripción"  required/>
                      </div>
                      <div class="col-md-1 col-sm-1"></div>
                  </div> 
                  ...
                  <div class="form-group">
                   <center>
                       <button type="submit" class="btn btn-primary" name="ingreso" size="24" style="width: 220px;">
                       <b>Iniciar Sesión</b>
                       </button>
                   </center>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <font color="WHITE" face="calibri" size="2">
              ...
              &copy
              <?php echo date('Y');?> - <U>Colegio Albert Einstein</U>.
                 <i></i>
          </p>
      </font>
    </div>
